      ...
      <main className='relative'>
        ...
        <div id='footer'>
          <div className='container mx-auto p-8'>
            <div className='flex justify-between md:flex-row flex-col justify-center items-center text-white font-bold'>
              ...
              <div className='pb-6 pt-8 md:pb-0 md:pt-0'>
                <span>Built Using Next.js and Tailwind CSS</span>
              </div>
              <div>
